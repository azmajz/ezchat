<template>
  <div class="auth-form">
    <div class="auth-form-header">
      ...
      <p class="auth-subtitle">Sign in to your EzChat account</p>
    </div>

    <form @submit.prevent="handleEmailLogin" class="auth-fields">
      ...
      <button type="submit" class="btn btn-primary w-full" :disabled="loading">
        <AppLoader v-if="loading" size="sm" color="white" />
    ...
    <button class="btn btn-google w-full" @click="handleGoogle" :disabled="loading">
