<template>
  <div class="sidebar">
    ...
    <div class="sidebar-footer">
      <button class="profile-btn" @click="showProfile = true" id="btn-profile">
        ...
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" opacity="0.4"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
      </button>
    </div>
  </div>
